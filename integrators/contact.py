...
def discrete_lag4(system, x0,x1,z0,t,dt):
    ...
    def z1b(b):
        ...
        kb2 = dt*system.lagq(b, (x1-x0)/dt, z0 + k1/2, t + dt/2) + .5*dt*system.lagz(b, (x1-x0)/dt, z0 + k1/2, t + dt/2)*kb1
        kb3 = dt*system.lagq(b, (x1-x0)/dt, z0 + k2/2, t + dt/2) + .5*dt*system.lagz(b, (x1-x0)/dt, z0 + k2/2, t + dt/2)*kb2
        kb4 = -4*system.lagv(x1, (x0+3*x1-4*b)/dt, z0 + k3, t + dt) + dt*system.lagz(x1, (x0+3*x1-4*b)/dt, z0 + k3, t + dt)*kb3
    ...
    def z1x0(b):
        ...
        k3 = dt*system.lag(b, (x1-x0)/dt, z0 + k2/2, t + dt/2)
        k4 = dt*system.lag(x1, (x0+3*x1-4*b)/dt, z0 + k3, t + dt)
        kx01 = dt*system.lagq(x0, (-3*x0-x1+4*b)/dt, z0, t) - 3*system.lagv(x0, (-3*x0-x1+4*b)/dt, z0, t)
        kx02 = -system.lagv(b, (x1-x0)/dt, z0 + k1/2, t + dt/2) + .5*dt*system.lagz(b, (x1-x0)/dt, z0 + k1/2, t + dt/2)*kx01
        kx03 = -system.lagv(b, (x1-x0)/dt, z0 + k2/2, t + dt/2) + .5*dt*system.lagz(b, (x1-x0)/dt, z0 + k2/2, t + dt/2)*kx02
        kx04 = system.lagv(x1, (x0+3*x1-4*b)/dt, z0 + k3, t + dt) + dt*system.lagz(x1, (x0+3*x1-4*b)/dt, z0 + k3, t + dt)*kx03
    ...
    def z1x1(b):
        ...
        kx12 = system.lagv(b, (x1-x0)/dt, z0 + k1/2, t + dt/2) + .5*dt*system.lagz(b, (x1-x0)/dt, z0 + k1/2, t + dt/2)*kx11
        kx13 = system.lagv(b, (x1-x0)/dt, z0 + k2/2, t + dt/2) + .5*dt*system.lagz(b, (x1-x0)/dt, z0 + k2/2, t + dt/2)*kx12
        kx14 = dt*system.lagq(x1, (x0+3*x1-4*b)/dt, z0 + k3, t + dt) + 3*system.lagv(x1, (x0+3*x1-4*b)/dt, z0 + k3, t + dt) + dt*system.lagz(x1, (x0+3*x1-4*b)/dt, z0 + k3, t + dt)*kx13
    ...
    def z1z0(b):
        ...
        kz02 = dt*system.lagz(b, (x1-x0)/dt, z0 + k1/2, t + dt/2) * (1 + kz01/2)
        kz03 = dt*system.lagz(b, (x1-x0)/dt, z0 + k2/2, t + dt/2) * (1 + kz02/2)
        kz04 = dt*system.lagz(x1, (x0+3*x1-4*b)/dt, z0 + k3, t + dt) * (1 + kz03)
...
def step_lag4(system, dt, p, q, s, t):
    lag = lambda x0,x1,z0: discrete_lag4(system, x0,x1,z0,t,dt)[0]
    lagx0 = lambda x0,x1,z0: discrete_lag4(system, x0,x1,z0,t,dt)[1]
    lagx1 = lambda x0,x1,z0: discrete_lag4(system, x0,x1,z0,t,dt)[2]
    lagz0 = lambda x0,x1,z0: discrete_lag4(system, x0,x1,z0,t,dt)[3]
